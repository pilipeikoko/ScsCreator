...
public class NrelCreator extends CustomCreator {
    ...
    public NrelCreator(String systemIdentifier, String definition, String statement, String russianIdentifier, String englishIdentifier) {
        init(systemIdentifier, definition, statement, russianIdentifier, englishIdentifier);
    }

    public NrelCreator(String systemIdentifier, String definition, String statement, String russianIdentifier, String englishIdentifier, int arity, String firstDomain, String secondDomain, boolean isSymmetric, boolean isReflexive, boolean isTransitive) {
        init(systemIdentifier, definition, statement, russianIdentifier, englishIdentifier);
        this.arity = arity;
